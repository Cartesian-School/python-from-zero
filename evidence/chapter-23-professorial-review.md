...
| `23-proj-03-sozdaem-project.html` | Чисто. Честная плашка «live-доступ к Projects ещё не предоставлен» читаема целиком. |
| `23-proj-04-kopiruem-project.html` | Чисто. |
| `23-proj-05-board-table-roadmap.html` | Таблица — чисто после фикса. 5-узловая flow_diagram нечитаема на 390px (см. находку выше, не исправлено). |
| `23-proj-06-polya.html` | Исходная точка обнаружения бага №1 (3 таблицы, включая 3-колоночную) — после фикса все три чисто. |
...
| `23-proj-09-issues.html` | Чисто. Реальный скриншот 14 Issues масштабируется корректно; исправленная подпись без «каждая закрыта своим PR» подтверждена. |
| `23-proj-10-redaktiruem-elementy.html` | Чисто. |
...
| `23-proj-13-avtomatizaciya.html` | Чисто. |

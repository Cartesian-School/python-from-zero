...
class GameStatus(Enum):
    """Явные состояния игры (раздел 21.22 сайта) — как enum.Enum из главы
...
class Game:
    ...
    def start_new_game(self) -> None:
        """Полный сброс контракта перезапуска (раздел 21.23 сайта): игрок,
    ...
    def handle_input(self, dt: float) -> None:
        ...
        реагирует на управление (раздел 21.19 сайта)."""
    ...
    def _update_playing(self, dt: float) -> None:
        """Порядок обновления одного кадра (раздел 21.21 сайта):
        1) ввод и движение игрока уже обработаны в handle_input();
        2) пули; 3) враги; 4) взрывы; 5) звёзды;
        6) спавн новых врагов (с сохранением «перелёта» времени);
    ...
    def render(self) -> None:
        ...
        if self.player.is_invulnerable:
            ...
            # индикатор временной неуязвимости (раздел 21.19 сайта).

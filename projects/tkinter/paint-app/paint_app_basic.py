"""Приложение для рисования на Tkinter — первый прототип (главы 18.1–18.7).

Состояние рисования живёт в глобальных переменных, фигуры создаются
напрямую на Canvas без модели документа — сознательный выбор для первой
версии (см. раздел 18.13). Финальная архитектура с DrawingState,
документом фигур и историей отмены — в paint_app.py.

Запуск: python paint_app_basic.py
"""

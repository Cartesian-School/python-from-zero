...
_proverka = _cells.get("8f64ffdb", {})  # "Проверка результата" -- zadacha_dlya_api() формирует словарь с bool-полем done
_zadanie = _cells.get("9f6279d6", {})  # "Задание ★★" -- spisok_dlya_api() применяет форматирование к списку записей

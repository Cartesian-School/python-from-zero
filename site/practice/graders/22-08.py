...
_proverka = _cells.get("16acd187", {})  # "Проверка результата" -- URL разобран на схему, хост, порт, путь, query и фрагмент
_zadanie = _cells.get("d4436178", {})  # "Задание ★" -- второй URL разобран верно: путь и параметр done

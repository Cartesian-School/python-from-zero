...
_proverka = _cells.get("0e4c711b", {})  # "Проверка результата" -- URL разобран на схему, хост, порт, путь, query и фрагмент
_zadanie = _cells.get("aa1a029f", {})  # "Задание ★" -- второй URL разобран верно: путь и параметр done

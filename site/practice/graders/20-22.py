...
_proverka = _cells.get("e2dc3d65", {})  # "Проверка результата" -- гравитация и отскок с затуханием
_zadanie = _cells.get("e1758643", {})   # "Задание ★" -- отскоки до почти полной остановки

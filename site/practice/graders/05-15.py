# Доверенный грейдер для практики 05-15 (не редактируется учеником).
#
...
_zadanie = _cells.get("fb83d433", {})  # Задание — площадь круга радиусом 10
...
checks = [
    ...
    {
        "name": "Задание: выведено 314.16",
        "passed": _zadanie.get('stdout','').strip() == "314.16",
    },
]
...
{"lesson_id": "05-15", "passed": passed, "score": score, "checks": checks}

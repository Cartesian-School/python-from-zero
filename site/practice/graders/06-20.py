# Доверенный грейдер для практики 06-20 (не редактируется учеником).
#
...
_zadanie = _cells.get("9f21bdc6", {})  # Задание — угол поворота для n=9 и n=12
...
checks = [
    ...
    {
        "name": "Задание: выведено 40.0 30.0",
        "passed": _zadanie.get('stdout','').strip() == "40.0 30.0",
    },
]
...
{"lesson_id": "06-20", "passed": passed, "score": score, "checks": checks}

# Доверенный грейдер для практики 05-09 (не редактируется учеником).
#
...
_zadanie = _cells.get("f7a73017", {})  # Задание — -3 ** 2 и (-3) ** 2
...
checks = [
    ...
    {
        "name": "Задание: выведено -9 9",
        "passed": _zadanie.get('stdout','').strip() == "-9 9",
    },
]
...
{"lesson_id": "05-09", "passed": passed, "score": score, "checks": checks}

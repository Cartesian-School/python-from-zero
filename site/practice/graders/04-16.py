# Доверенный грейдер для практики 04-16 (не редактируется учеником).
#
...
_zadanie = _cells.get("3fc1263b", {})  # Задание — сумма покупки
...
checks = [
    ...
    {
        "name": "Задание: выведено 74.97",
        "passed": '74.97' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-16", "passed": passed, "score": score, "checks": checks}

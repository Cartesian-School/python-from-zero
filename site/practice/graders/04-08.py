# Доверенный грейдер для практики 04-08 (не редактируется учеником).
#
...
_zadanie = _cells.get("2f448f0e", {})  # Задание — скидка
...
checks = [
    ...
    {
        "name": "Задание: выведено 850.0",
        "passed": '850' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-08", "passed": passed, "score": score, "checks": checks}

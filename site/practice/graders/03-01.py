# Доверенный грейдер для практики 03-01 (не редактируется учеником).
#
...
_zadanie = _cells.get("d683ef5a", {})  # "Задание ★ Базовая практика"
_samost = _cells.get("e6349230", {})   # "Самостоятельная практика ★★"
...
checks = [
    ...
    {
        "name": "Задание ★: выведено минимум 3 строки (имя, город, число)",
    ...
    {
        "name": "Самостоятельная практика ★★: выведено минимум 2 строки",
        "passed": len(_samost_lines) >= 2,
    },
]
...
{"lesson_id": "03-01", "passed": passed, "score": score, "checks": checks}

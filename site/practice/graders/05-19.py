# Доверенный грейдер для практики 05-19 (не редактируется учеником).
#
...
_zadanie = _cells.get("8a37f9aa", {})  # Задание — sample(range(1,6), k=3) при seed(3)
...
checks = [
    ...
    {
        "name": "Задание: выведено [2, 5, 4]",
        "passed": _zadanie.get('stdout','').strip() == "[2, 5, 4]",
    },
]
...
{"lesson_id": "05-19", "passed": passed, "score": score, "checks": checks}

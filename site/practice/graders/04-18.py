# Доверенный грейдер для практики 04-18 (не редактируется учеником).
#
...
_zadanie = _cells.get("b9d54a30", {})  # Задание — модуль z=5+12j
...
checks = [
    ...
    {
        "name": "Задание: выведено 13",
        "passed": '13' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-18", "passed": passed, "score": score, "checks": checks}

# Доверенный грейдер для практики 05-12 (не редактируется учеником).
#
...
_zadanie = _cells.get("4de7a1a1", {})  # Задание — x ** 2 + 2 * x + 1 при x = 5
...
checks = [
    ...
    {
        "name": "Задание: выведено 36",
        "passed": _zadanie.get('stdout','').strip() == "36",
    },
]
...
{"lesson_id": "05-12", "passed": passed, "score": score, "checks": checks}

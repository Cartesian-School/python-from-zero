# Доверенный грейдер для практики 21-13 (не редактируется учеником).
#
...
_proverka = _cells.get("6b026c93", {})  # "Проверка результата" -- интервал между выстрелами

checks = [
    {
        "name": "Проверка результата: скорострельность ограничена и не зависит от FPS",
...
{"lesson_id": "21-13", "passed": passed, "score": score, "checks": checks}

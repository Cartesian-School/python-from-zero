# Доверенный грейдер для практики 05-21 (не редактируется учеником).
#
...
_zadanie = _cells.get("e5379820", {})  # Задание — исправленное среднее трёх оценок
...
checks = [
    ...
    {
        "name": "Задание: выведено 4.0",
        "passed": _zadanie.get('stdout','').strip() == "4.0",
    },
]
...
{"lesson_id": "05-21", "passed": passed, "score": score, "checks": checks}

# Доверенный грейдер для практики 07-23 (не редактируется учеником).
#
...
_zadanie = _cells.get("cebd577c", {})  # Задание — число обновлений экрана без update()
...
checks = [
    ...
    {
        "name": "Задание: выведено 0",
        "passed": _zadanie.get('stdout','').strip() == "0",
    },
]
...
{"lesson_id": "07-23", "passed": passed, "score": score, "checks": checks}

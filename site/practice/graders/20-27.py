# Доверенный грейдер для практики 20-27 (не редактируется учеником).
#
...
_proverka = _cells.get("57197c89", {})  # "Проверка результата" -- бюджет кадра и его остаток

checks = [
    {
        "name": "Проверка результата: бюджет кадра и его остаток посчитаны верно",
...
{"lesson_id": "20-27", "passed": passed, "score": score, "checks": checks}

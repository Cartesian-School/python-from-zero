# Доверенный грейдер для практики 04-13 (не редактируется учеником).
#
...
_zadanie = _cells.get("e1818f59", {})  # Задание — 1.1 + 2.2
...
checks = [
    ...
    {
        "name": "Задание: проверено сравнение с 3.3",
        "passed": 'False' in _zadanie.get('stdout','') or 'True' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-13", "passed": passed, "score": score, "checks": checks}

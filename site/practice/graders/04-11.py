# Доверенный грейдер для практики 04-11 (не редактируется учеником).
#
...
_zadanie = _cells.get("2a9ca8fe", {})  # Задание — площадь квадрата
...
checks = [
    ...
    {
        "name": "Задание: выведено 81",
        "passed": '81' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-11", "passed": passed, "score": score, "checks": checks}

# Доверенный грейдер для практики 06-19 (не редактируется учеником).
#
...
_zadanie = _cells.get("998528e7", {})  # Задание — курс и координата после серии команд
...
checks = [
    ...
    {
        "name": "Задание: выведено 0 (170, 80)",
        "passed": _zadanie.get('stdout','').strip() == "0 (170, 80)",
    },
]
...
{"lesson_id": "06-19", "passed": passed, "score": score, "checks": checks}

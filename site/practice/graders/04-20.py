# Доверенный грейдер для практики 04-20 (не редактируется учеником).
#
...
_zadanie = _cells.get("83410074", {})  # Задание — токен secrets
...
checks = [
    ...
    {
        "name": "Задание: выведена длина токена 16",
        "passed": '16' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-20", "passed": passed, "score": score, "checks": checks}

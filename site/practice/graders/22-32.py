...
_uyazvimyj = _cells.get("831db00e", {})  # "Проверка результата — таблица пострадала" -- уязвимый вариант действительно повредил таблицу
_bezopasnyj = _cells.get("28cdb0b2", {})  # "Эксперимент — параметризованный" -- параметризованный запрос защитил таблицу

...
_uyazvimyj = _cells.get("5b65dfca", {})  # "Проверка результата — таблица пострадала" -- уязвимый вариант действительно повредил таблицу
_bezopasnyj = _cells.get("51f44cc8", {})  # "Эксперимент — параметризованный" -- параметризованный запрос защитил таблицу

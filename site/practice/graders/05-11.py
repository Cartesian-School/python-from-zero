# Доверенный грейдер для практики 05-11 (не редактируется учеником).
#
...
_zadanie = _cells.get("e9a81a1b", {})  # Задание — среднее трёх чисел
...
checks = [
    ...
    {
        "name": "Задание: выведено 20.0",
        "passed": _zadanie.get('stdout','').strip() == "20.0",
    },
]
...
{"lesson_id": "05-11", "passed": passed, "score": score, "checks": checks}

# Доверенный грейдер для практики 07-25 (не редактируется учеником).
#
...
_zadanie = _cells.get("7e350c60", {})  # Задание — двигает ли черепашку clear/reset/home
...
checks = [
    ...
    {
        "name": "Задание: выведено False True True",
        "passed": _zadanie.get('stdout','').strip() == "False True True",
    },
]
...
{"lesson_id": "07-25", "passed": passed, "score": score, "checks": checks}

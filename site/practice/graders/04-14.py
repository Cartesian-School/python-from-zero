# Доверенный грейдер для практики 04-14 (не редактируется учеником).
#
...
_zadanie = _cells.get("426f656a", {})  # Задание — isclose для 1.1+2.2
...
checks = [
    ...
    {
        "name": "Задание: isclose вернул True",
...
{"lesson_id": "04-14", "passed": passed, "score": score, "checks": checks}

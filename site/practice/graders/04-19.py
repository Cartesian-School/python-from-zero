# Доверенный грейдер для практики 04-19 (не редактируется учеником).
#
...
_zadanie = _cells.get("bd3abf6b", {})  # Задание — гипотенуза
...
checks = [
    ...
    },
    {
        ...
        "passed": '10' in _zadanie.get('stdout',''),
    },
]
...
{"lesson_id": "04-19", "passed": passed, "score": score, "checks": checks}

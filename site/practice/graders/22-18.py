...
_proverka = _cells.get("a28aeccd", {})  # "Проверка результата" -- выбор фреймворка соответствует таблице сравнения
_zadanie = _cells.get("5b3c07ce", {})  # "Задание ★★" -- добавлен верный выбор для низкоуровневого контроля над ASGI

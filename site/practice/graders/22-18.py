...
_proverka = _cells.get("2cf32e1f", {})  # "Проверка результата" -- выбор фреймворка соответствует таблице сравнения
_zadanie = _cells.get("37aa2c04", {})  # "Задание ★★" -- добавлен верный выбор для низкоуровневого контроля над ASGI

# Доверенный грейдер для практики 05-07 (не редактируется учеником).
#
...
_zadanie = _cells.get("4d9dfcd3", {})  # Задание — команды и остаток
...
checks = [
    ...
    {
        "name": "Задание: выведено 5 2",
        "passed": _zadanie.get('stdout','').strip() == "5 2",
    },
]
...
{"lesson_id": "05-07", "passed": passed, "score": score, "checks": checks}

# Доверенный грейдер для практики 05-18 (не редактируется учеником).
#
...
_zadanie = _cells.get("4d83e255", {})  # Задание — randint(1,10) при seed(1)
...
checks = [
    ...
    {
        "name": "Задание: выведено 3",
        "passed": _zadanie.get('stdout','').strip() == "3",
    },
]
...
{"lesson_id": "05-18", "passed": passed, "score": score, "checks": checks}

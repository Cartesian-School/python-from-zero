# Доверенный грейдер для практики 05-16 (не редактируется учеником).
#
...
_zadanie = _cells.get("89d56099", {})  # Задание — sin(90°)
...
checks = [
    ...
    {
        "name": "Задание: выведено 1.0",
        "passed": _zadanie.get('stdout','').strip() == "1.0",
    },
]
...
{"lesson_id": "05-16", "passed": passed, "score": score, "checks": checks}

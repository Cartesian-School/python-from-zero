# Доверенный грейдер для практики 05-14 (не редактируется учеником).
#
...
_zadanie = _cells.get("9ea8298d", {})  # Задание — gcd(48,18) и comb(6,2)
...
checks = [
    ...
    {
        "name": "Задание: выведено 6 15",
        "passed": _zadanie.get('stdout','').strip() == "6 15",
    },
]
...
{"lesson_id": "05-14", "passed": passed, "score": score, "checks": checks}

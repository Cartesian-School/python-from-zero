...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ...
            ChapterSectionLink("18.3", "Панель инструментов и параметры", "18-03-menu-parametry.html", "395"),
            ChapterSectionLink("18.4", "Позиция мыши и рисуем линии", "18-04-mysh-linii.html", "398"),
            ChapterSectionLink("18.5", "Квадраты, прямоугольники, круги и овалы", "18-05-figury.html", "401"),
            ChapterSectionLink("18.6", "Выбираем размер и цвет", "18-06-razmer-cveta.html", "403"),
            ChapterSectionLink("18.7", "Первая полная программа", "18-07-polnaya-programma-itogi.html", "407"),
            ChapterSectionLink("18.8", "Canvas хранит объекты, а не пиксели", "18-08-mentalnaya-model.html", "409"),
            ChapterSectionLink("18.9", "Система координат Canvas", "18-09-sistema-koordinat.html", "411"),
            ChapterSectionLink("18.10", "Item ID: что возвращает create_*", "18-10-item-id.html", "413"),
            ChapterSectionLink("18.11", "Теги: группируем и выбираем элементы", "18-11-tegi.html", "415"),
            ChapterSectionLink("18.12", "Жизненный цикл жеста мыши", "18-12-zhest-myshi.html", "417"),
            ChapterSectionLink("18.13", "Состояние рисования", "18-13-sostoyanie-risovaniya.html", "419"),
            ChapterSectionLink("18.14", "Карандаш: непрерывный штрих", "18-14-karandash.html", "421"),
            ChapterSectionLink("18.15", "Инструмент «Линия»", "18-15-instrument-liniya.html", "423"),
            ChapterSectionLink("18.16", "Геометрия прямоугольника", "18-16-geometriya-pryamougolnika.html", "425"),
            ChapterSectionLink("18.17", "Геометрия овала", "18-17-geometriya-ovala.html", "427"),
            ChapterSectionLink("18.18", "Живое превью: coords()", "18-18-zhivoe-prevyu.html", "429"),
            ChapterSectionLink("18.19", "itemconfig, move, delete", "18-19-redaktirovanie-elementov.html", "431"),
            ChapterSectionLink("18.20", "Порядок наложения", "18-20-poryadok-sloev.html", "433"),
            ChapterSectionLink("18.21", "Система цвета", "18-21-sistema-cveta.html", "435"),
            ChapterSectionLink("18.22", "Толщина кисти", "18-22-tolschina-kisti.html", "437"),
            ChapterSectionLink("18.23", "Ластик", "18-23-lastik.html", "439"),
            ChapterSectionLink("18.24", "Отмена действий (Undo)", "18-24-otmena-deystviy.html", "441"),
            ChapterSectionLink("18.25", "Повтор действий (Redo)", "18-25-povtor-deystviy.html", "443"),
            ChapterSectionLink("18.26", "Очистка холста", "18-26-ochistka-holsta.html", "445"),
            ChapterSectionLink("18.27", "Горячие клавиши", "18-27-goryachie-klavishi.html", "447"),
            ChapterSectionLink("18.28", "Строка состояния", "18-28-stroka-sostoyaniya.html", "449"),
            ChapterSectionLink("18.29", "Архитектура PaintApp", "18-29-arhitektura-paintapp.html", "451"),
            ChapterSectionLink("18.30", "Сохранение и загрузка JSON", "18-30-sohranenie-json.html", "453"),
            ChapterSectionLink("18.31", "Debug Labs", "18-31-debug-labs.html", "455"),
            ChapterSectionLink("18.32", "Paint Pro — итоги главы", "18-32-paint-pro-itogi.html", "459"),
        ],
    )

...
страницы перед каждой главой, нумерация страниц. После рендеринга скрипт находит физическую
страницу начала каждой главы (через `document.render().pages[i].anchors`) и сверяет её с
канонической страницей из `manifest/coverage_manifest.json` — печатает СБОЙ, если глава
начинается раньше канонической страницы. Типографику (кегль, интерлиньяж, формат страницы)
пришлось подобрать так, чтобы обеспечить нужную плотность текста: итоговый файл — 636 страниц
(требование — ≥545).

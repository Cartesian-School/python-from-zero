...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ...
            ChapterSectionLink("5.6", "Присваивание и порядок вычислений", "05-03-prisvaivanie-poryadok.html"),
            ...
            ChapterSectionLink("5.10", "Модуль math — карта возможностей", "05-04-matematicheskie-funkcii.html"),
            ...
            ChapterSectionLink("5.16", "Модуль random: псевдослучайность", "05-05-sluchaynye-chisla.html"),
            ...
            ChapterSectionLink("5.21", "Мини-проекты и итоги", "05-06-mini-proekt-itogi.html"),
        ],
    )

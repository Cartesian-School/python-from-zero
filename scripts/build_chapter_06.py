...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("6.1", "Приступаем", "06-01-pristupaem.html"),
            ChapterSectionLink("6.2", "Координаты: центр (0, 0)", "06-09-koordinaty.html"),
            ChapterSectionLink("6.3", "Заставляем Turtle двигаться", "06-02-dvizhenie-vpered-nazad.html"),
            ChapterSectionLink("6.4", "Направление и угол", "06-10-napravlenie-i-ugol.html"),
            ChapterSectionLink("6.5", "Меняем направление", "06-03-povorot-cherepashki.html"),
            ChapterSectionLink("6.6", "Первые фигуры и формула 360/n", "06-11-pervye-figury.html"),
            ChapterSectionLink("6.7", "Мини-проекты: квадрат и шестиугольник", "06-04-mini-proekty-figury.html"),
            ChapterSectionLink("6.8", "Сокращённые приёмы", "06-05-sokraschennye-priemy.html"),
            ChapterSectionLink("6.9", "Поднять и опустить перо", "06-12-pero-vverh-vniz.html"),
            ChapterSectionLink("6.10", "goto() и координатная панель", "06-07-goto-kvadrat.html"),
            ChapterSectionLink("6.11", "Цвет, толщина и внешний вид", "06-13-cvet-tolschina-vid.html"),
            ChapterSectionLink("6.12", "Заливка, круг, дуга и точка", "06-14-zalivka-krug-tochka.html"),
            ChapterSectionLink("6.13", "Случайные точки на экране", "06-06-sluchaynye-tochki.html"),
            ChapterSectionLink("6.14", "Случайное движение", "06-15-sluchaynoe-dvizhenie.html"),
            ChapterSectionLink("6.15", "Рисуем по координатам", "06-16-risuem-po-koordinatam.html"),
            ChapterSectionLink("6.16", "Отладка Turtle", "06-17-otladka-turtle.html"),
            ChapterSectionLink("6.17", "Мини-проекты", "06-18-mini-proekty.html"),
            ChapterSectionLink("6.18", "Мандала и итоги", "06-08-mandala-itogi.html"),
        ],
    )

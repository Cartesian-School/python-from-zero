...
PAGES = [
    ...
    ("14-16-super.html", "super() и порядок поиска методов"),
...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("14.1", "Что такое ООП?", "14-01-chto-takoe-oop.html"),
            ChapterSectionLink("", "Давайте это докажем!", "14-01-chto-takoe-oop.html#dokazhem"),
            ChapterSectionLink("14.2", "Классы и объекты со своими значениями", "14-02-klassy.html"),
            ChapterSectionLink("", "Объекты со своими значениями", "14-02-klassy.html#znacheniya"),
            ChapterSectionLink("14.3", "Управляем объектами. Действия объектов", "14-03-upravlyaem-obektami.html"),
            ChapterSectionLink("14.4", "Гонка Turtle с объектами", "14-04-gonka-turtle-obekty-itogi.html"),
            ChapterSectionLink("14.5", "self и связывание методов", "14-05-self-i-svyazyvanie-metodov.html"),
            ChapterSectionLink("14.6", "__init__ и создание объекта", "14-06-init-i-sozdanie-obekta.html"),
            ChapterSectionLink("14.7", "Атрибуты экземпляра и класса", "14-07-atributy-ekzemplyara-i-klassa.html"),
            ChapterSectionLink("14.8", "Ловушка общего изменяемого атрибута", "14-08-lovushka-obshchego-atributa.html"),
            ChapterSectionLink("14.9", "Мини-проект: Player", "14-09-mini-proekt-player.html"),
            ChapterSectionLink("14.10", "Инкапсуляция", "14-10-inkapsulyatsiya.html"),
            ChapterSectionLink("14.11", "property: вычисляемые атрибуты", "14-11-property.html"),
            ChapterSectionLink("14.12", "Мини-проект: Rectangle", "14-12-mini-proekt-rectangle.html"),
            ChapterSectionLink("14.13", "Композиция: объекты внутри объектов", "14-13-kompozitsiya.html"),
            ChapterSectionLink("14.14", "Мини-проект: Корзина покупок v2", "14-14-mini-proekt-korzina-v2.html"),
            ChapterSectionLink("14.15", "Наследование", "14-15-nasledovanie.html"),
            ChapterSectionLink("14.16", "super() и порядок поиска методов", "14-16-super.html"),
            ChapterSectionLink("14.17", "Переопределение методов", "14-17-pereopredelenie-metodov.html"),
            ChapterSectionLink("14.18", "Полиморфизм", "14-18-polimorfizm.html"),
            ChapterSectionLink("14.19", "Duck typing", "14-19-duck-typing.html"),
            ChapterSectionLink("14.20", "Мини-проект: полиморфные фигуры", "14-20-mini-proekt-figury.html"),
            ChapterSectionLink("14.21", "Специальные методы", "14-21-spetsialnye-metody.html"),
            ChapterSectionLink("14.22", "Практика: применяем __str__ и __eq__", "14-22-primenyaem-dunder-metody.html"),
            ChapterSectionLink("14.23", "dataclasses", "14-23-dataclasses.html"),
            ChapterSectionLink("14.24", "Практика: dataclass", "14-24-praktika-dataclass.html"),
            ChapterSectionLink("14.25", "Класс или не класс? Проектируем модели", "14-25-proektiruem-modeli.html"),
            ChapterSectionLink("14.26", "Мини-проект: гонка Turtle v2", "14-26-mini-proekt-gonka-v2.html"),
            ChapterSectionLink("", "Итоги главы", "14-27-itogi-glavy.html"),
        ],
    )
...
{callout(
        "info",
        "Граница вводного курса",
        "Полное правило MRO использует C3-линеаризацию и особенно важно при множественном "
        "наследовании. Здесь рассматривается прозрачный случай одиночного наследования; "
        "множественное наследование остаётся за рамками курса.",
    )}
...
{debug_lab(
    ...
    page(
        "14-16-super.html",
        page_title="super() и порядок поиска методов",
        description="super() как способ дополнить, а не заменить поведение родителя; порядок поиска при одиночном наследовании; границы MRO; Debug Lab: неверный порядок вызова.",
        kicker_suffix="super()",
        h1="super() и порядок поиска методов",
...
def build_17() -> None:
    ...
    дочернего класса первой (порядок поиска разобран в разделе 14.16) и использует именно её:</p>
    {code_block(
        "pereopredelenie.py",
        "class Zhivotnoe:\n"
        "    def zvuk(self):\n"

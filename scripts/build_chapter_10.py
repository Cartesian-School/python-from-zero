...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("10.1", "Повторение и первый цикл for", "10-01-cikly-for.html"),
            ChapterSectionLink("", "Три структуры алгоритма: вспоминаем", "10-01-cikly-for.html#tri-struktury"),
            ChapterSectionLink("", "Канонический flowchart цикла for", "10-01-cikly-for.html#flowchart-for"),
            ChapterSectionLink("10.2", "range() подробно", "10-09-range-podrobno.html"),
            ChapterSectionLink("10.3", "Индекс, значение и enumerate()", "10-10-enumerate-i-nakoplenie.html"),
            ChapterSectionLink("", "Мини-проект: анализатор текста", "10-10-enumerate-i-nakoplenie.html#analizator-teksta"),
            ChapterSectionLink("10.4", "if внутри циклов for", "10-02-if-vlozhennye-cikly.html"),
            ChapterSectionLink("", "Вложенные циклы for", "10-02-if-vlozhennye-cikly.html#vlozhennye"),
            ChapterSectionLink("", "Мини-проект: таблица умножения", "10-02-if-vlozhennye-cikly.html#tablica-umnozheniya"),
            ChapterSectionLink("10.5", "Перебор строк, циклы while", "10-03-perebor-strok-while.html"),
            ChapterSectionLink("", "Бесконечный цикл и while True", "10-03-perebor-strok-while.html#while-true"),
            ChapterSectionLink("10.6", "break, continue и loop-else", "10-04-break-continue.html"),
            ChapterSectionLink("", "Мини-проект: цикл команд", "10-04-break-continue.html#cikl-komand"),
            ChapterSectionLink("10.7", "Поиск, фильтрация и суммирование", "10-11-poisk-filtr-summa.html"),
            ChapterSectionLink("10.8", "Проверка ввода в цикле", "10-12-proverka-vvoda.html"),
            ChapterSectionLink("10.9", "Мини-проект — «Угадай число», версия 2", "10-05-mini-proekt-ugadaj-v2.html"),
            ChapterSectionLink("10.10", "Отладка циклов: 10 типичных ошибок", "10-13-otladka-ciklov.html"),
            ChapterSectionLink("10.11", "Мини-проект — автоматизируем фигуры", "10-06-avtomatiziruem-figury.html"),
            ChapterSectionLink("10.12", "Мини-проект — автоматически рисуем мандалу", "10-07-avtomatiziruem-mandalu.html"),
            ChapterSectionLink("10.13", "Случайные узоры Turtle", "10-14-sluchajnye-uzory.html"),
            ChapterSectionLink("10.14", "Сетка фигур: вложенные циклы в Turtle", "10-15-setka-figur.html"),
            ChapterSectionLink("10.15", "Спирали из дуг и итоги", "10-08-spirali-itogi.html"),
            ChapterSectionLink("", "Итоги главы", "10-08-spirali-itogi.html#itogi"),
        ],
    )

...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("15.1", "Зачем нужны файлы? Открытие и чтение", "15-01-zachem-fajly.html"),
            ChapterSectionLink("15.2", "Строка за строкой", "15-02-stroka-za-strokoj.html"),
            ChapterSectionLink("15.3", "Создание новых файлов", "15-03-sozdanie-fajlov.html"),
            ChapterSectionLink("15.4", "Мини-проект: дневник заметок", "15-04-mini-proekt-itogi.html"),
            ChapterSectionLink("15.5", "Файл, папка и файловая система", "15-05-fajl-i-papka.html"),
            ChapterSectionLink("15.6", "Пути: абсолютные и относительные", "15-06-puti-absolyutnye-i-otnositelnye.html"),
            ChapterSectionLink("15.7", "Текущая рабочая директория (CWD)", "15-07-tekushaya-rabochaya-directoriya.html"),
            ChapterSectionLink("15.8", "pathlib.Path: пути как объекты", "15-08-pochemu-pathlib.html"),
            ChapterSectionLink("15.9", "Разбираем путь: name, stem, suffix, parent", "15-09-razbiraem-put.html"),
            ChapterSectionLink("15.10", "Практика: пути и CWD", "15-10-praktika-puti-i-cwd.html"),
            ChapterSectionLink("15.11", "open() возвращает объект файла", "15-11-file-object.html"),
            ChapterSectionLink("15.12", "Жизненный цикл файла и with", "15-12-zhiznenny-cikl-i-with.html"),
            ChapterSectionLink("15.13", "Курсор файла: tell() и seek()", "15-13-kursor-fajla.html"),
            ChapterSectionLink("15.14", "Читаем файлы: read(), readline(), readlines()", "15-14-chitaem-fajly.html"),
            ChapterSectionLink("15.15", "Пишем в файлы: write() и режимы r/w/a/x", "15-15-pishem-i-rezhimy.html"),
            ChapterSectionLink("15.16", "Текст, bytes и кодировка UTF-8", "15-16-text-bytes-encoding.html"),
            ChapterSectionLink("15.17", "Бинарные файлы и переносы строк", "15-17-binarnye-fajly-i-perevody-strok.html"),
            ChapterSectionLink("15.18", "pathlib: read_text/write_text/read_bytes/write_bytes", "15-18-pathlib-udobnye-metody.html"),
            ChapterSectionLink("15.19", "Папки: exists(), is_file(), mkdir()", "15-19-papki-exists-mkdir.html"),
            ChapterSectionLink("15.20", "Поиск файлов: iterdir() и glob()", "15-20-poisk-fajlov-glob.html"),
            ChapterSectionLink("15.21", "Переименование, копирование, удаление", "15-21-pereimenovanie-kopirovanie-udalenie.html"),
            ChapterSectionLink("15.22", "Ошибки файловой системы", "15-22-oshibki-fajlovoj-sistemy.html"),
            ChapterSectionLink("15.23", "Большие файлы и потоковая обработка", "15-23-bolshie-fajly-i-potoki.html"),
            ChapterSectionLink("15.24", "Как выбрать формат хранения данных", "15-24-kak-vybrat-format.html"),
            ChapterSectionLink("15.25", "JSON: сохраняем структуры данных", "15-25-json-serializatsiya.html"),
            ChapterSectionLink("15.26", "Мини-проект: сохраняем Player", "15-26-mini-proekt-save-player.html"),
            ChapterSectionLink("15.27", "CSV: таблицы в текстовом виде", "15-27-csv-tablitsy.html"),
            ChapterSectionLink("15.28", "Безопасная работа с файлами", "15-28-bezopasnaya-rabota-s-fajlami.html"),
            ChapterSectionLink("15.29", "Мини-проект: таблица рекордов", "15-29-mini-proekt-rekordy-i-nastrojki.html"),
            ChapterSectionLink("15.30", "Браузер и локальный диск", "15-30-brauzer-vs-lokalny-disk.html"),
            ChapterSectionLink("15.31", "Итоги главы: инструментарий работы с файлами", "15-31-itogi-glavy.html"),
        ],
    )

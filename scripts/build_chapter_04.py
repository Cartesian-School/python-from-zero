...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("4.1", "Что такое число для компьютера", "04-01-chisla-i-peremennye.html"),
            ...
            ChapterSectionLink("4.4", "Комментарии в вычислениях", "04-02-kommentarii.html"),
            ...
            ChapterSectionLink("4.9", "Карта числовых типов", "04-03-vidy-chisel.html"),
            ChapterSectionLink("4.10", "float — дробные числа", "04-12-float-osnovy.html"),
            ...
            ChapterSectionLink("4.16", "complex и cmath", "04-18-kompleksnye-chisla.html"),
            ChapterSectionLink("4.17", "Преобразование типов чисел", "04-04-preobrazovanie-tipov.html"),
            ...
            ChapterSectionLink("4.22", "Мини-проекты и итоги", "04-05-mini-proekt-itogi.html"),
        ],
    )
...
{practice_card(
        "04-03",
        "Практика: числа бывают разных видов",
        "Интерактивная карта выбора числового типа — закрепляет обзор этого раздела",

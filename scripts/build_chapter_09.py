...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ...
            ChapterSectionLink("9.3", "Истина или ложь", "09-01-istina-ili-lozh.html", "180"),
            ChapterSectionLink("9.4", "Сравниваем и принимаем решение", "09-02-sravnenie-i-reshenie.html", "182"),
            ChapterSectionLink("9.5", "== против =, и сравнение строк", "09-09-ravno-i-sravnenie-strok.html", "185"),
            ChapterSectionLink("9.6", "Цепочки сравнений", "09-10-cepochki-sravnenij.html", "187"),
            ChapterSectionLink("9.7", "Truthiness и None", "09-11-truthiness-i-none.html", "189"),
            ChapterSectionLink("9.8", "Если это произошло — выполни команду!", "09-03-if-inache.html", "192"),
            ChapterSectionLink("9.9", "elif — несколько вариантов", "09-12-elif-lestnica.html", "196"),
            ChapterSectionLink("9.10", "Несколько if ≠ if/elif/else", "09-13-neskolko-if-protiv-elif.html", "199"),
            ChapterSectionLink("9.11", "and — все условия сразу", "09-14-and.html", "201"),
            ChapterSectionLink("9.12", "or — хотя бы одно", "09-15-or.html", "203"),
            ChapterSectionLink("9.13", "not — переворачиваем условие", "09-16-not.html", "205"),
            ChapterSectionLink("9.14", "Больше одного условия!", "09-04-neskolko-uslovij.html", "207"),
            ChapterSectionLink("9.15", "Short-circuit: Python иногда ленится", "09-17-short-circuit.html", "209"),
            ChapterSectionLink("9.16", "in / not in как условие", "09-18-in-not-in.html", "212"),
            ChapterSectionLink("9.17", "is против ==", "09-19-is-vs-ravno.html", "214"),
            ChapterSectionLink("9.18", "Вложенные условия", "09-20-vlozhennye-uslovija.html", "216"),
            ChapterSectionLink("9.19", "Проектируем условие", "09-21-proektirovanie-uslovij.html", "219"),
            ChapterSectionLink("9.20", "Отладка логических ошибок", "09-22-otladka-logiki.html", "222"),
            ChapterSectionLink("9.21", "Мини-проект — «Угадай число»", "09-05-mini-proekt-ugadaj-chislo.html", "225"),
            ChapterSectionLink("9.22", "Мини-проекты — клуб и погода", "09-23-mini-proekt-klub-i-pogoda.html", "229"),
            ChapterSectionLink("9.23", "Мини-проекты — оценки и команды", "09-24-mini-proekt-ocenki-i-komandy.html", "232"),
            ChapterSectionLink("9.24", "Условия накапливаются и итоги", "09-06-nakoplenie-uslovij-itogi.html", "235"),
            ChapterSectionLink("", "Итоги", "09-06-nakoplenie-uslovij-itogi.html#itogi", "239"),
        ],
    )

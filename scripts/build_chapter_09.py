...
def build_19() -> None:
    ...
    {callout(
        ...
        "Python, которые не гарантированы и могут отличаться в разных ситуациях. CPython "
        "дополнительно выводит <code class=\"inline\">SyntaxWarning: \"is\" with a literal. "
        "Did you mean \"==\"?</code>; это предупреждение нужно исправить, а не игнорировать. Это не то, "

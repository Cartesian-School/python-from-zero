...
def reference_illustration() -> str:
  ...
  <text x="48" y="52" fill="#8fb7fe" opacity=".62" font-family="JetBrains Mono, monospace" font-size="11" letter-spacing="2">INDEX / KNOWLEDGE MAP</text>
  <text x="468" y="342" fill="#b9a0fc" opacity=".52" font-family="JetBrains Mono, monospace" font-size="11">x: reference</text>
</svg>"""

...
def practice_illustration() -> str:
    """Decorative "write -> run -> verify -> progress" workstation scene for the
    homepage Practice section intro. Purely illustrative — the section's real
    ...
    """
    return """<svg class="practice-art" viewBox="0 0 560 380" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet">
  <defs>
    <linearGradient id="practice-bg" x1=".05" y1="0" x2=".95" y2="1">
      <stop offset="0" stop-color="#171044"/><stop offset="1" stop-color="#09021f"/>
    </linearGradient>
    <linearGradient id="practice-node-grad" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#185DFA"/><stop offset="1" stop-color="#5B24F9"/>
    </linearGradient>
    <pattern id="practice-grid" width="26" height="26" patternUnits="userSpaceOnUse">
      <path d="M26 0H0V26" fill="none" stroke="#8fb7fe" stroke-width=".7" opacity=".12"/>
    </pattern>
  </defs>

  <rect width="560" height="380" rx="28" fill="url(#practice-bg)"/>
  <rect width="560" height="380" rx="28" fill="url(#practice-grid)"/>
  <circle cx="524" cy="34" r="90" fill="#fff" opacity=".05"/>
  <circle cx="26" cy="352" r="100" fill="#000" opacity=".1"/>
  <path d="M40 344C150 360 300 366 520 340" fill="none" stroke="#8fb7fe" stroke-width="1.5" stroke-dasharray="1 8" opacity=".3"/>

  <g class="practice-art__panel">
    <rect x="28" y="44" width="236" height="190" rx="18" fill="#fff" opacity=".97"/>
    <rect x="44" y="58" width="60" height="20" rx="8" fill="#0D0230" opacity=".07"/>
    <circle cx="40" cy="68" r="3" fill="#5B24F9"/>
    <text x="54" y="72" font-family="JetBrains Mono, monospace" font-size="10" fill="#0D0230" opacity=".55">.py</text>

    <g class="practice-run" aria-hidden="true">
      <circle cx="240" cy="68" r="14" fill="#185DFA"/>
      <path d="M235 61L235 75L250 68Z" fill="#fff"/>
    </g>
    <circle class="practice-run-glow" cx="240" cy="68" r="14" fill="none" stroke="#8FB7FE" stroke-width="2" opacity="0"/>

    <text x="44" y="108" font-family="JetBrains Mono, monospace" font-size="12.5">
      <tspan fill="#185DFA">numbers</tspan><tspan fill="#0D0230" opacity=".55"> = </tspan><tspan fill="#5B24F9">[2, 4, 6]</tspan>
    </text>
    <text x="44" y="134" font-family="JetBrains Mono, monospace" font-size="12.5">
      <tspan fill="#0D0230">total</tspan><tspan fill="#0D0230" opacity=".55"> = </tspan><tspan fill="#185DFA">sum</tspan><tspan fill="#0D0230" opacity=".55">(numbers)</tspan>
    </text>

    <rect x="40" y="146" width="212" height="24" rx="7" fill="#8FB7FE" opacity=".16"/>
    <rect x="40" y="146" width="3" height="24" rx="1.5" fill="#185DFA"/>
    <text x="52" y="163" font-family="JetBrains Mono, monospace" font-size="12.5">
      <tspan fill="#185DFA">print</tspan><tspan fill="#0D0230" opacity=".55">(total)</tspan>
    </text>
    <rect class="practice-caret" x="186" y="150" width="2" height="17" fill="#0D0230"/>

    <g class="practice-chip practice-chip--browser">
      <rect x="44" y="198" width="80" height="24" rx="12" fill="#EAF1FF"/>
      <text x="84" y="214" text-anchor="middle" font-family="JetBrains Mono, monospace" font-size="10.5" fill="#0C43F1">Браузер</text>
    </g>
    <g class="practice-chip practice-chip--local">
      <rect x="132" y="198" width="84" height="24" rx="12" fill="#F2F2F6"/>
      <text x="174" y="214" text-anchor="middle" font-family="JetBrains Mono, monospace" font-size="10.5" fill="#6B6B7D">Локально</text>
    </g>
  </g>

  <path class="practice-track" d="M264 108H336" fill="none" stroke="#8FB7FE" stroke-width="2" stroke-dasharray="1 7" stroke-linecap="round" opacity=".4"/>
  <path class="practice-signal" d="M264 108H336" fill="none" stroke="#185DFA" stroke-width="3" stroke-linecap="round" stroke-dasharray="14 100" stroke-dashoffset="0" opacity="0"/>

  <g class="practice-node">
    <circle class="practice-node-glow" cx="300" cy="108" r="30" fill="none" stroke="#8FB7FE" stroke-width="2" opacity="0"/>
    <circle cx="300" cy="108" r="24" fill="url(#practice-node-grad)"/>
    <text x="300" y="113" text-anchor="middle" font-family="JetBrains Mono, monospace" font-size="11" fill="#fff" opacity=".9">&gt;&gt;&gt;</text>
  </g>

  <g class="practice-art__panel">
    <rect x="336" y="44" width="196" height="112" rx="18" fill="#fff" opacity=".97"/>
    <text x="356" y="66" font-family="JetBrains Mono, monospace" font-size="10.5" fill="#6B6B7D" letter-spacing="1">Результат</text>
    <text class="practice-output-idle" x="356" y="114" font-family="JetBrains Mono, monospace" font-size="20" fill="#B4B4C4">···</text>
    <g class="practice-output-value" opacity="0">
      <text x="356" y="114" font-family="JetBrains Mono, monospace" font-size="15" fill="#185DFA">&gt;</text>
      <text x="378" y="115" font-family="JetBrains Mono, monospace" font-size="22" font-weight="700" fill="#0D0230">12</text>
    </g>
  </g>

  <g class="practice-art__panel">
    <rect x="336" y="168" width="196" height="48" rx="14" fill="#fff" opacity=".97"/>
    <text x="356" y="196" font-family="JetBrains Mono, monospace" font-size="11.5" fill="#0D0230" opacity=".7">Проверка</text>
    <circle cx="486" cy="192" r="12" fill="none" stroke="#0D0230" stroke-width="2" opacity=".22"/>
    <circle class="practice-check-fill" cx="486" cy="192" r="12" fill="#22C55E" opacity="0"/>
    <path class="practice-check-mark" d="M481 193L485 197L493 187" fill="none" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="20" stroke-dashoffset="0"/>
    <text class="practice-check-count" x="506" y="196" font-family="JetBrains Mono, monospace" font-size="11" fill="#0D0230" opacity="0">1/1</text>
  </g>

  <g class="practice-art__panel practice-art__panel--float">
    <rect x="336" y="224" width="196" height="46" rx="14" fill="#fff" opacity=".97"/>
    <text x="356" y="244" font-family="JetBrains Mono, monospace" font-size="10.5" fill="#6B6B7D" letter-spacing="1">Прогресс</text>
    <rect x="356" y="252" width="156" height="6" rx="3" fill="#E4E4EC"/>
    <rect class="practice-progress-fill" x="356" y="252" width="156" height="6" rx="3" fill="url(#practice-node-grad)"/>
  </g>

  <text x="44" y="352" font-family="JetBrains Mono, monospace" font-size="11" fill="#8fb7fe" opacity=".55" letter-spacing="1">ПИШИ → ЗАПУСКАЙ → ПРОВЕРЯЙ</text>
</svg>"""

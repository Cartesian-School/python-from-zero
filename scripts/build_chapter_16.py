...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("16.1", "Tkinter — правильно всё настраиваем!", "16-01-nastraivaem-tkinter.html"),
            ChapterSectionLink("16.2", "Метки, кнопки и pack", "16-02-metki-knopki-pack.html"),
            ChapterSectionLink("16.3", "Поля ввода", "16-03-polya-vvoda.html"),
            ChapterSectionLink("16.4", "Переменные Tkinter", "16-04-peremennye-tkinter.html"),
            ChapterSectionLink("16.5", "Множество вариантов!", "16-05-mnozhestvo-variantov.html"),
            ChapterSectionLink("16.6", "Меню", "16-06-menu.html"),
            ChapterSectionLink("16.7", "Строки и столбцы — grid", "16-07-grid.html"),
            ChapterSectionLink("16.8", "Мини-проект: калькулятор чаевых", "16-08-mini-proekt-chaevye-itogi.html"),
            ChapterSectionLink("16.9", "От терминала к GUI: событийная модель", "16-09-ot-terminala-k-gui.html"),
            ChapterSectionLink("16.10", "Как работает событийный цикл и mainloop", "16-10-event-loop-i-mainloop.html"),
            ChapterSectionLink("16.11", "Виджет и дерево интерфейса", "16-11-derevo-widgetov.html"),
            ChapterSectionLink("16.12", "tk и ttk", "16-12-tk-i-ttk.html"),
            ChapterSectionLink("16.13", "Frame и LabelFrame", "16-13-frame-i-labelframe.html"),
            ChapterSectionLink("16.14", "pack подробно", "16-14-pack-podrobno.html"),
            ChapterSectionLink("16.15", "Адаптивный grid", "16-15-adaptivny-grid.html"),
            ChapterSectionLink("16.16", "Виджеты выбора", "16-16-widgety-vybora.html"),
            ChapterSectionLink("16.17", "Progressbar и Notebook", "16-17-progressbar-i-notebook.html"),
            ChapterSectionLink("16.18", "Messagebox и диалоги", "16-18-messagebox-i-dialogi.html"),
            ChapterSectionLink("16.19", "filedialog и pathlib", "16-19-filedialog-i-pathlib.html"),
            ChapterSectionLink("16.20", "Toplevel: несколько окон", "16-20-toplevel.html"),
            ChapterSectionLink("16.21", "Focus, клавиатура и доступность", "16-21-focus-i-dostupnost.html"),
            ChapterSectionLink("16.22", "after(): таймеры без блокировки", "16-22-after-tajmery.html"),
            ChapterSectionLink("16.23", "Валидация ввода", "16-23-validatsiya-vvoda.html"),
            ChapterSectionLink("16.24", "Архитектура приложения", "16-24-arhitektura-prilozheniya.html"),
            ChapterSectionLink("16.25", "Класс приложения и настройки", "16-25-klass-prilozheniya-i-nastrojki.html"),
            ChapterSectionLink("16.26", "Мини-проект: счётчик кликов", "16-26-mini-proekt-schetchik-klikov.html"),
            ChapterSectionLink("16.27", "Мини-проект: конвертер температур", "16-27-mini-proekt-konverter-temperatur.html"),
            ChapterSectionLink("16.28", "Мини-проект: таймер обратного отсчёта", "16-28-mini-proekt-tajmer.html"),
            ChapterSectionLink("16.29", "Мини-проект: список задач", "16-29-mini-proekt-todo.html"),
            ChapterSectionLink("16.30", "Мини-проект: редактор заметок", "16-30-mini-proekt-zametki.html"),
            ChapterSectionLink("16.31", "Tip Calculator Pro", "16-31-tip-calculator-pro.html"),
            ChapterSectionLink("16.32", "Отладка интерфейса и качество GUI", "16-32-debugging-i-kachestvo.html"),
            ChapterSectionLink("16.33", "Итоги главы: инструментарий Tkinter", "16-33-itogi-glavy.html"),
        ],
    )

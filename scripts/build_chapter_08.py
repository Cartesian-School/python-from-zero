...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ...
            ChapterSectionLink("8.3", "Многострочные и raw-строки", "08-12-mnogostrochnye-i-raw-stroki.html", "141"),
            ChapterSectionLink("8.4", "Кавычки, склеивание, повторение", "08-02-kavychki-konkatenaciya.html", "143"),
            ChapterSectionLink("8.5", "Длина строки: len()", "08-13-dlina-stroki.html", "146"),
            ChapterSectionLink("8.6", "Индексы строки", "08-03-dostup-k-simvolam.html", "148"),
            ChapterSectionLink("8.7", "Срезы строки", "08-14-srezy-stroki.html", "151"),
            ChapterSectionLink("8.8", "Строки нельзя изменить", "08-15-neizmenyaemost.html", "155"),
            ChapterSectionLink("8.9", "Методы строк: регистр и пробелы", "08-04-metody-strok.html", "157"),
            ChapterSectionLink("8.10", "Методы строк: поиск и разбор", "08-16-metody-strok-poisk-i-razbor.html", "160"),
            ChapterSectionLink("8.11", "Методы проверки: isalpha и другие", "08-17-metody-proverki.html", "163"),
            ChapterSectionLink("8.12", "in, сравнение и истинность", "08-05-istina-lozh.html", "165"),
            ChapterSectionLink("8.13", "Перебираем строку в цикле", "08-18-cikl-po-stroke.html", "167"),
            ChapterSectionLink("8.14", "Форматирование строк", "08-06-formatirovanie-strok.html", "169"),
            ChapterSectionLink("8.15", "Ввод от пользователя", "08-07-vvod-polzovatelya.html", "173"),
            ChapterSectionLink("8.16", "Кириллица, юникод и эмодзи", "08-19-unikod-i-emodzi.html", "176"),
            ChapterSectionLink("8.17", "Отладка проблем со строками", "08-20-otladka-strok.html", "178"),
            ChapterSectionLink("8.18", "Мини-проект — текст Turtle", "08-08-mini-proekt-turtle-tekst.html", "181"),
            ChapterSectionLink("8.19", "Мини-проект — приветствие и ФИО", "08-21-mini-proekt-privetstvie-i-imya.html", "183"),
            ChapterSectionLink("8.20", "Мини-проекты — крик и переворот", "08-09-mini-proekty-krik-perevorot.html", "185"),
            ChapterSectionLink("8.21", "Мини-проект — пароль и e-mail", "08-22-mini-proekt-parol-i-email.html", "187"),
            ChapterSectionLink("8.22", "Мини-проект — счётчик слов", "08-23-mini-proekt-schetchik-slov.html", "189"),
            ChapterSectionLink("8.23", "Мини-проект — динамическая математика", "08-10-mini-proekt-matematika-itogi.html", "191"),
            ChapterSectionLink("", "Итоги", "08-10-mini-proekt-matematika-itogi.html#itogi", "194"),
        ],
    )

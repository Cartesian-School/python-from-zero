...
def build_30() -> None:
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:14px;align-items:start">
      ...
      {image_figure(f"{IMG}/win-pulse-final.png", "После эффекта линия остаётся в постоянном цвете подсветки", "Установившееся состояние полного приложения.", width=260)}
    </div>

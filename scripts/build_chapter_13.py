...
def build_opener() -> None:
    out = render_chapter_opener(
        ...
        sections=[
            ChapterSectionLink("13.1", "Зачем программе функции", "13-09-zachem-programme-funkcii.html"),
            ChapterSectionLink("13.2", "Настоящая автоматизация. Первая функция", "13-01-nastoyashaya-avtomatizaciya.html"),
            ChapterSectionLink("13.3", "Что происходит во время вызова", "13-10-vyzov-i-vozvrat-upravlenie.html"),
            ChapterSectionLink("13.4", "Параметр и аргумент", "13-02-zachem-funkcii.html"),
            ChapterSectionLink("13.5", "Изменяемые и неизменяемые аргументы", "13-11-izmenyaemye-i-nezmenyaemye-argumenty.html"),
            ChapterSectionLink("13.6", "Позиционные и именованные аргументы", "13-12-pozicionnye-i-imennye.html"),
            ChapterSectionLink("13.7", "Значения по умолчанию и *args", "13-04-argumenty.html"),
            ChapterSectionLink("", "Ловушка изменяемого значения по умолчанию", "13-04-argumenty.html#lovushka"),
            ChapterSectionLink("13.8", "*args, **kwargs и распаковка", "13-13-args-kwargs-raspakovka.html"),
            ChapterSectionLink("13.9", "Positional-only и keyword-only", "13-14-positional-only-keyword-only.html"),
            ChapterSectionLink("13.10", "Возвращаем ответ", "13-03-vozvrashaem-otvet.html"),
            ChapterSectionLink("13.11", "Вход, работа, выход: чистые функции", "13-15-funkcii-vhod-vyhod.html"),
            ChapterSectionLink("13.12", "Глобальные и локальные переменные", "13-05-globalnye-lokalnye.html"),
            ChapterSectionLink("13.13", "Вложенные функции и nonlocal", "13-16-vlozhennye-funkcii-nonlocal.html"),
            ChapterSectionLink("13.14", "Стек вызовов и traceback", "13-17-stek-vyzovov.html"),
            ChapterSectionLink("13.15", "Проектируем хорошую функцию", "13-18-proektiruem-funkciyu.html"),
            ChapterSectionLink("13.16", "Докстринги и подсказки типов", "13-19-dokumentaciya-i-tipy.html"),
            ChapterSectionLink("13.17", "Функции как объекты", "13-20-funkcii-kak-obekty.html"),
            ChapterSectionLink("13.18", "Лямбда-функции", "13-06-lambda.html"),
            ChapterSectionLink("13.19", "Функции как конвейер", "13-21-funkcii-kak-konvejer.html"),
            ChapterSectionLink("13.20", "Рефакторим проекты главы 12", "13-22-refaktoring-glavy-12.html"),
            ChapterSectionLink("13.21", "Debug Lab: типичные ошибки функций", "13-23-debug-lab-funkcii.html"),
            ChapterSectionLink("13.22", "Тестируем функции", "13-24-testirovanie-funkcij.html"),
            ChapterSectionLink("13.23", "Мини-проект — домашнее задание по математике", "13-07-mini-proekt-domashka.html"),
            ChapterSectionLink("13.24", "Мини-проект — анализатор текста v2", "13-25-mini-proekt-analizator-v2.html"),
            ChapterSectionLink("13.25", "Мини-проекты — конвертер и утилиты коллекций", "13-26-mini-proekt-konverter-i-utility.html"),
            ChapterSectionLink("13.26", "Мини-проект — Turtle Function Studio", "13-08-mini-proekt-figury-itogi.html"),
            ChapterSectionLink("", "Итоги главы", "13-08-mini-proekt-figury-itogi.html#itogi"),
        ],
    )
